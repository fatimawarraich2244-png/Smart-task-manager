    ...
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gradient mb-2">Join SmartTask</h1>
          <p className="text-slate-400 text-sm">Create an account to start leveling up.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button 
            type="submit" 
            className="btn btn-primary w-full py-3 text-base mt-4" 
            disabled={isLoading}
          >
        ...
        <div className="mt-8 text-center text-sm text-slate-400">
          Already have an account? <Link to="/login" className="text-primary font-semibold hover:text-primary-hover">Login</Link>
        </div>
      </motion.div>
    </div>
  );
